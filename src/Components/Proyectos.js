    ...
    <div className="Container_All_Proyectos" id="Proyectos">
      ...
      <div className="Proyectos">
          ...
          <div style={{ pointerEvents: "none" }}>
            ...
            <div className="Info">
              ...
              <h2 style={{ marginBottom: "4.5rem" }}>
                ...
                Permitiendote añadirla a la lista, Editar su usuario Y
                Eliminarlo
              </h2>
              <div className="Tech">
                <h2>
        ...
        <div className="Proyecto">
          <div style={{ pointerEvents: "none" }}>
            <img
              src="https://res.cloudinary.com/aca-geek/image/upload/v1656004763/PORTAFOLIO/Peliculas_ghm9cf.png"
              className="Image"
              width="280px"
              height="100px"
              alt=""
            ...
            <div className="Info">
              ...
              <h2 style={{ marginBottom: "4.5rem" }}>
                Podras ver informacion acerca de las ultimas peliculas
                publicadas, sus calificaciones, y mucho mas!!
              </h2>
              <div className="Tech">
                <h2>
                  {" "}
              ...
              <div className="LinkProyectos">
                <a
                  style={{ color: "#cdcdff" }}
                  href="https://github.com/Francovo/Sprint3Grupo7"
                  target="_blank"
                  rel="noreferrer"
                >
                  <SiGithub size={23} />
                ...
                <a
                  style={{ color: "#cdcdff" }}
                  href="https://sprint3-grupo7.vercel.app/home"
                  target="_blank"
                  rel="noreferrer"
                >
                  <ImShare size={23} style={{}} />
